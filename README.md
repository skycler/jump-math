...
- **Five Themes**: Forest 🌲, Snowy Mountains 🏔️, Beach 🏖️, City 🏙️, Sky ☀️
- **Theme-Specific Obstacles**:
  ...
  - ☀️ Sky: Colorful clouds, airplanes, CO₂ gas clouds
  - ☀️ Himmel: Colorful clouds, airplanes, CO₂ gas clouds
- **Game Modes**:
...
1. Select a theme (Forest, Snow, Beach, City, or Sky)
